...
import { getAllMedicamentsByUserAndDays } from '../../service/medicamentService';



const ViewMedications = ({route}) => {
  ...
  const obtenerMedicamentos = async () => {
    ...
    const medicamentsResponse = await getAllMedicamentsByUserAndDays(userId, selectedDay, "Activo");
